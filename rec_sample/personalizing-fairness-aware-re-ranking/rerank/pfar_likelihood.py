...
class LikelihoodBasedPfarReranker:
    ...
    def rerank(
        ...
        for _ in range(top_n):
            ...
            for movie_id in movie_ids:
                ...
                # calculate diversity bonus based on likelihood
                if total_selected == 0:
                    diversity_bonus = 1.0
                else:
                    p = provider_counts.get(provider, 0) / total_selected
                    diversity_bonus = np.log(1 / (1 - p + 1e-6))
